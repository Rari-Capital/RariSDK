...
export default class JumpRateModelV2 {
    init(interestRateModelAddress, assetAddress, provider) {
        return __awaiter(this, void 0, void 0, function* () {
            const jumpRateModelContract = createContract(interestRateModelAddress, compoundProtocolABI.contracts["contracts/JumpRateModel.sol:JumpRateModel"].abi, provider);
