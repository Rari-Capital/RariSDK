...
export default class DAIInterestRateModelV2 extends JumpRateModel {
    init(interestRateModelAddress, assetAddress, provider) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const interestRateContract = createContract(interestRateModelAddress, compoundProtocolABI.contracts['contracts/DAIInterestRateModelV2.sol:DAIInterestRateModelV2'].abi, provider);
            this.dsrPerBlock = toBN(yield interestRateContract.callStatic.dsrPerBlock());
            const cTokenContract = createContract(assetAddress, compoundProtocolABI.contracts['contracts/CTokenInterfaces.sol:CTokenInterface'].abi, provider);
