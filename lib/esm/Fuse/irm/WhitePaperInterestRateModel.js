...
export default class WhitePaperInterestRateModel {
    init(interestRateModelAddress, assetAddress, provider) {
        return __awaiter(this, void 0, void 0, function* () {
            const whitePaperModelContract = createContract(interestRateModelAddress, compoundProtocolABI.contracts["contracts/WhitePaperInterestRateModel.sol:WhitePaperInterestRateModel"].abi, provider);
            ...
            const cTokenContract = createContract(assetAddress, JSON.parse(compoundProtocolABI.contracts["contracts/CTokenInterfaces.sol:CTokenInterface"].abi), provider);
