...
// ABIs v1.0.0
const RariFundController_json_1 = __importDefault(require("./yield/abi/legacy/v1.0.0/RariFundController.json"));
const RariFundProxy_json_1 = __importDefault(require("./yield/abi/legacy/v1.0.0/RariFundProxy.json"));
// ABIs v1.1.0
const RariFundProxy_json_2 = __importDefault(require("./yield/abi/legacy/v1.1.0/RariFundProxy.json"));
const legacyABIS = {
    "v1.0.0": {
...
class YieldPool extends stable_1.default {
    constructor(provider, subpools, getAllTokens) {
        ...
        this.contracts = {
            RariFundController: new contracts_1.Contract("0x9245efB59f6491Ed1652c2DD8a4880cBFADc3ffA", YieldPool.CONTRACT_ABIS["RariFundController"], this.provider),
            RariFundManager: new contracts_1.Contract("0x59FA438cD0731EBF5F4cDCaf72D4960EFd13FCe6", YieldPool.CONTRACT_ABIS["RariFundManager"], this.provider),
            RariFundToken: new contracts_1.Contract("0x3baa6B7Af0D72006d3ea770ca29100Eb848559ae", YieldPool.CONTRACT_ABIS["RariFundToken"], this.provider),
            RariFundPriceConsumer: new contracts_1.Contract("0x00815e0e9d118769542ce24be95f8e21c60e5561", YieldPool.CONTRACT_ABIS["RariFundPriceConsumer"], this.provider),
            RariFundProxy: new contracts_1.Contract("0x35DDEFa2a30474E64314aAA7370abE14c042C6e8", YieldPool.CONTRACT_ABIS["RariFundProxy"], this.provider)
        };
        this.legacyContracts = {
            "v1.0.0": {
                "RariFundController": new contracts_1.Contract("0x6afE6C37bF75f80D512b9D89C19EC0B346b09a8d", RariFundController_json_1.default, this.provider),
                "RariFundProxy": new contracts_1.Contract("0x6dd8e1Df9F366e6494c2601e515813e0f9219A88", RariFundProxy_json_1.default, this.provider)
            },
            "v1.1.0": {
                "RariFundProxy": new contracts_1.Contract("0x626d6979F3607d13051594d8B27a0A64E413bC11", RariFundProxy_json_2.default, this.provider)
            }
        };
        this.rypt = this.rspt;
        delete this.rspt;
