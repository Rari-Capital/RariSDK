...
// Current ABIs
const RariFundController_json_1 = __importDefault(require("./stable/abi/RariFundController.json"));
const RariFundManager_json_1 = __importDefault(require("./stable/abi/RariFundManager.json"));
const RariFundToken_json_1 = __importDefault(require("./stable/abi/RariFundToken.json"));
const RariFundPriceConsumer_json_1 = __importDefault(require("./stable/abi/RariFundPriceConsumer.json"));
const RariFundProxy_json_1 = __importDefault(require("./stable/abi/RariFundProxy.json"));
// Legacy ABIs (v1.0.0)
const RariFundManager_json_2 = __importDefault(require("./stable/abi/legacy/v1.0.0/RariFundManager.json"));
const RariFundToken_json_2 = __importDefault(require("./stable/abi/legacy/v1.0.0/RariFundToken.json"));
const RariFundProxy_json_2 = __importDefault(require("./stable/abi/legacy/v1.0.0/RariFundProxy.json"));
// Legacy ABIs (v1.1.0)
const RariFundManager_json_3 = __importDefault(require("./stable/abi/legacy/v1.1.0/RariFundManager.json"));
const RariFundController_json_2 = __importDefault(require("./stable/abi/legacy/v1.1.0/RariFundController.json"));
const RariFundProxy_json_3 = __importDefault(require("./stable/abi/legacy/v1.1.0/RariFundProxy.json"));
// Legacy ABIs (v1.2.0)
const RariFundProxy_json_4 = __importDefault(require("./stable/abi/legacy/v1.2.0/RariFundProxy.json"));
// Legacy ABIs (v2.0.0)
const RariFundManager_json_4 = __importDefault(require("./stable/abi/legacy/v2.0.0/RariFundManager.json"));
const RariFundController_json_3 = __importDefault(require("./stable/abi/legacy/v2.0.0/RariFundController.json"));
const RariFundProxy_json_5 = __importDefault(require("./stable/abi/legacy/v2.0.0/RariFundProxy.json"));
// Legacy ABIs (v2.2.0)
const RariFundProxy_json_6 = __importDefault(require("./stable/abi/legacy/v2.2.0/RariFundProxy.json"));
// Legacy ABIs (v2.4.0)
const RariFundProxy_json_7 = __importDefault(require("./stable/abi/legacy/v2.4.0/RariFundProxy.json"));
// Legacy ABIs (v2.5.0)
const RariFundController_json_4 = __importDefault(require("./stable/abi/legacy/v2.5.0/RariFundController.json"));
// Mstable
const mstable_js_1 = __importDefault(require("../subpools/mstable.js"));
// Contract addresses
...
const abisStable = {
    ...
    RariFundPriceConsumer: RariFundPriceConsumer_json_1.default,
...
const legacyAbis = {
    "v1.0.0": {
        RariFundManager: RariFundManager_json_2.default,
        RariFundToken: RariFundToken_json_2.default,
        RariFundProxy: RariFundProxy_json_2.default,
    },
    "v1.1.0": {
        RariFundController: RariFundController_json_2.default,
        RariFundManager: RariFundManager_json_3.default,
        RariFundProxy: RariFundProxy_json_3.default,
    },
    "v1.2.0": {
        RariFundProxy: RariFundProxy_json_4.default,
    },
    "v2.0.0": {
        RariFundController: RariFundController_json_3.default,
        RariFundManager: RariFundManager_json_4.default,
        RariFundProxy: RariFundProxy_json_5.default,
    },
    "v2.2.0": {
        RariFundProxy: RariFundProxy_json_6.default,
    },
    "v2.4.0": {
        RariFundProxy: RariFundProxy_json_7.default,
    },
    "v2.5.0": {
        RariFundController: RariFundController_json_4.default,
    },
};
class StablePool {
    constructor(provider, subpools, getAllTokens) {
        ...
        this.cache = new cache_js_1.default({
            usdPrices: 300,
            allBalances: 30,
        ...
        this.contracts = {
            RariFundController: new ethers_1.Contract(contractAddressesStable["RariFundController"], abisStable["RariFundController"], this.provider),
            RariFundManager: new ethers_1.Contract(contractAddressesStable["RariFundManager"], abisStable["RariFundManager"], this.provider),
            RariFundToken: new ethers_1.Contract(contractAddressesStable["RariFundToken"], abisStable["RariFundToken"], this.provider),
            RariFundPriceConsumer: new ethers_1.Contract(contractAddressesStable["RariFundPriceConsumer"], abisStable["RariFundPriceConsumer"], this.provider),
            RariFundProxy: new ethers_1.Contract(contractAddressesStable["RariFundProxy"], abisStable["RariFundProxy"], this.provider)
        };
        this.legacyContracts = {
            "v1.0.0": {
                RariFundManager: new ethers_1.Contract(legacyContractAddresses["v1.0.0"]["RariFundManager"], legacyAbis["v1.0.0"]["RariFundManager"], this.provider),
                RariFundToken: new ethers_1.Contract(legacyContractAddresses["v1.0.0"]["RariFundToken"], legacyAbis["v1.0.0"]["RariFundToken"], this.provider),
                RariFundProxy: new ethers_1.Contract(legacyContractAddresses["v1.0.0"]["RariFundProxy"], legacyAbis["v1.0.0"]["RariFundProxy"], this.provider),
            },
            "v1.1.0": {
                RariFundController: new ethers_1.Contract(legacyContractAddresses["v1.1.0"]["RariFundController"], legacyAbis["v1.1.0"]["RariFundController"], this.provider),
                RariFundManager: new ethers_1.Contract(legacyContractAddresses["v1.1.0"]["RariFundManager"], legacyAbis["v1.1.0"]["RariFundManager"], this.provider),
                RariFundProxy: new ethers_1.Contract(legacyContractAddresses["v1.1.0"]["RariFundProxy"], legacyAbis["v1.1.0"]["RariFundProxy"], this.provider),
            },
            "v1.2.0": {
                RariFundProxy: new ethers_1.Contract(legacyContractAddresses["v1.2.0"]["RariFundProxy"], legacyAbis["v1.2.0"]["RariFundProxy"], this.provider),
            },
            "v2.0.0": {
                RariFundController: new ethers_1.Contract(legacyContractAddresses["v2.0.0"]["RariFundController"], legacyAbis["v2.0.0"]["RariFundController"], this.provider),
                RariFundManager: new ethers_1.Contract(legacyContractAddresses["v2.0.0"]["RariFundManager"], legacyAbis["v2.0.0"]["RariFundManager"], this.provider),
                RariFundProxy: new ethers_1.Contract(legacyContractAddresses["v2.0.0"]["RariFundProxy"], legacyAbis["v2.0.0"]["RariFundProxy"], this.provider),
            },
            "v2.2.0": {
                RariFundProxy: new ethers_1.Contract(legacyContractAddresses["v2.2.0"]["RariFundProxy"], legacyAbis["v2.2.0"]["RariFundProxy"], this.provider),
            },
            "v2.4.0": {
                RariFundProxy: new ethers_1.Contract(legacyContractAddresses["v2.4.0"]["RariFundProxy"], legacyAbis["v2.4.0"]["RariFundProxy"], this.provider),
            },
            "v2.5.0": {
                RariFundController: new ethers_1.Contract(legacyContractAddresses["v2.5.0"]["RariFundController"], legacyAbis["v2.5.0"]["RariFundController"], this.provider),
            }
        };
        var self = this;
        this.balances = {
            ...
            getTotalInterestAccrued: (fromBlock = 0, toBlock = "latest") => __awaiter(this, void 0, void 0, function* () {
                ...
                if (fromBlock === 0 && toBlock === "latest")
                    ...
                    try {
                        return (yield axios_1.default.get(self.API_BASE_URL + "interest", { params: { fromBlock, toBlock }, })).data;
                    }
                    catch (e) {
            ...
            interestAccruedBy: (account, fromTimestamp = 0, toTimestamp = "latest") => __awaiter(this, void 0, void 0, function* () {
                ...
                if (toTimestamp === undefined)
                    toTimestamp = "latest";
                try {
                    return (yield axios_1.default.get(self.API_BASE_URL + "interest/" + account, { params: { fromTimestamp, toTimestamp } })).data;
                }
                catch (e) {
                    throw new Error("Error in Rari API: " + e);
                }
            ...
            transfer: (recipient, amount) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (!amount || !ethers_1.BigNumber.from(amount) || !amount.gt(ethers_1.constants.Zero))
                    throw new Error("Amount is not a valid BN instance greater than 0.");
                const fundBalanceBN = ethers_1.BigNumber.from(yield self.contracts.RariFundManager.callStatic.getFundBalance());
                const rftTotalSupplyBN = ethers_1.BigNumber.from(yield self.contracts.RariFundToken.callStatic.totalSupply());
        ...
        this.allocations = {
            ...
            getRawCurrencyAllocations: () => __awaiter(this, void 0, void 0, function* () {
                var allocationsByCurrency = {
                    ...
                    BUSD: ethers_1.constants.Zero,
                    sUSD: ethers_1.constants.Zero,
                    mUSD: ethers_1.constants.Zero,
                };
                ...
                for (var i = 0; i < allBalances["0"].length; i++) {
                    ...
                    const contractBalanceBN = ethers_1.BigNumber.from(allBalances["1"][i]);
                    allocationsByCurrency[currencyCode] = contractBalanceBN;
                    const pools = allBalances["2"][i];
                    const poolBalances = allBalances["3"][i];
                    for (let j = 0; j < pools.length; j++) {
                        const poolBalanceBN = ethers_1.BigNumber.from(poolBalances[j]);
            ...
            getRawCurrencyAllocationsInUsd: () => __awaiter(this, void 0, void 0, function* () {
                ...
                for (var i = 0; i < allBalances["0"].length; i++) {
                    const currencyCode = allBalances["0"][i];
                    const priceInUsdBN = ethers_1.BigNumber.from(allBalances["4"][i]);
                    const contractBalanceBN = ethers_1.BigNumber.from(allBalances["1"][i]);
                    const contractBalanceUsdBN = contractBalanceBN
                        .mul(priceInUsdBN)
                        .div(internalTokens[currencyCode].decimals === 18
                        ? ethers_1.constants.WeiPerEther
                        : ethers_1.BigNumber.from(Math.pow(10, internalTokens[currencyCode].decimals)));
            ...
            getCurrencyUsdPrices: () => __awaiter(this, void 0, void 0, function* () {
                ...
                const allBalances = yield self.cache.getOrUpdate("allBalances", self.contracts.RariFundProxy.callStatic.getRawFundBalancesAndPrices);
                for (var i = 0; i < allBalances["0"].length; i++) {
                    prices[allBalances["0"][i]] = ethers_1.BigNumber.from(allBalances["4"][i]);
                }
                return prices;
            })
        };
        this.apy = {
            getCurrentRawApy: () => __awaiter(this, void 0, void 0, function* () {
                let factors = [];
                let totalBalanceUsdBN = ethers_1.constants.Zero;
                // Get all Balances
                const allBalances = yield self.cache.getOrUpdate("allBalances", self.contracts.RariFundProxy.callStatic.getRawFundBalancesAndPrices);
                // Get raw balance
                for (var i = 0; i < allBalances["0"].length; i++) {
                    ...
                    const contractBalanceUsdBN = contractBalanceBN
                        ...
                        ? ethers_1.constants.WeiPerEther
                        : ethers_1.BigNumber.from(Math.pow(10, internalTokens[currencyCode].decimals)));
                    factors.push([contractBalanceUsdBN, ethers_1.constants.Zero]);
                    ...
                    for (let j = 0; j < pools.length; j++) {
                        ...
                        const poolBalanceUsdBN = poolBalanceBN
                            ...
                            ? ethers_1.constants.WeiPerEther
                            : ethers_1.BigNumber.from(Math.pow(10, internalTokens[currencyCode].decimals)));
                        const poolApyBN = poolBalanceUsdBN.gt(ethers_1.constants.Zero)
                ...
                for (var i = 0; i < factors.length; i++) {
                    apyBN = apyBN.add(factors[i][0]
                        .mul(factors[i][1].gt(ethers_1.constants.Zero)
                        ? factors[i][1]
                        : ethers_1.constants.Zero).div(totalBalanceUsdBN));
                }
                ;
                return apyBN;
            }),
            getCurrentApy: function () {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    return rawFundApy.sub(rawFundApy.mul(fee).div(ethers_1.constants.WeiPerEther));
                });
            },
            ...
            getApyOverTime: function (fromTimestamp = 0, toTimestamp = "latest") {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        return ethers_1.BigNumber.from((yield axios_1.default.get(self.API_BASE_URL + "apy", {
        ...
        this.history = {
            getApyHistory: function (fromTimestamp, toTimestamp, intervalSeconds = 86400) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        return (yield axios_1.default.get(self.API_BASE_URL + "apys", {
            ...
            getTotalSupplyHistory: function (fromTimestamp = "latest", toTimestamp = "latest", intervalSeconds = 86400) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (!intervalSeconds)
                        intervalSeconds = 86400;
                    try {
                        return (yield axios_1.default.get(self.API_BASE_URL + "balances", {
                            params: { fromTimestamp, toTimestamp, intervalSeconds },
                        })).data;
                    }
                    catch (error) {
            ...
            getBalanceHistoryOf: function (account, fromBlock, toBlock, intervalBlocks = 6500) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (!intervalBlocks)
                        intervalBlocks = 6500;
                    try {
                        return (yield axios_1.default.get(self.API_BASE_URL + "balances/" + account, {
            ...
            getPoolTokenExchangeRateHistory: function (fromTimestamp, toTimestamp, intervalSeconds = 86400) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (!intervalSeconds)
                        intervalSeconds = 86400;
                    try {
                        return (yield axios_1.default.get(self.API_BASE_URL +
            ...
            validateDeposit: function (currencyCode, amount, sender, getSlippage) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (directlyDepositableCurrencyCodes.indexOf(currencyCode) >= 0) {
                        ...
                        const amountUsdBN = amount.mul(ethers_1.BigNumber.from(allBalances["4"][self.allocations.CURRENCIES.indexOf(currencyCode)]))
                            .div(ethers_1.BigNumber.from(10)
                            .pow(ethers_1.BigNumber.from(internalTokens[currencyCode].decimals)));
                        return [amountUsdBN.toString(), null, ethers_1.constants.Zero];
                    }
                    else {
                        ...
                        if (currencyCode === "mUSD" || mstable_js_1.default.SUPPORTED_EXCHANGE_CURRENCIES.indexOf(currencyCode) >= 0) {
                            ...
                            for (let acceptedCurrency of directlyDepositableCurrencyCodes) {
                                ...
                                if (acceptedCurrency === "mUSD" || mstable_js_1.default.SUPPORTED_EXCHANGE_CURRENCIES.indexOf(acceptedCurrency) >= 0) {
                                    ...
                                    if (currencyCode === "mUSD") {
                                        ...
                                        if (!redeemValidity || !redeemValidity["0"])
                                            continue;
                                        mStableOutputAmountAfterFeeBN = ethers_1.BigNumber.from(redeemValidity["2"]);
                                        ...
                                        if (!maxSwap || !maxSwap["0"] || amount.gt(ethers_1.BigNumber.from(maxSwap["2"])))
                                            continue;
                                        ...
                                        var outputAmountBeforeFeesBN = amount
                                            ...
                                            ? ethers_1.constants.WeiPerEther
                                            : ethers_1.BigNumber.from(Math.pow(10, internalTokens[acceptedCurrency].decimals)))
                                            .div(internalTokens[currencyCode].decimals >= 18
                                            ? ethers_1.constants.WeiPerEther
                                            : ethers_1.BigNumber.from(Math.pow(10, internalTokens[currencyCode].decimals)));
                        ...
                        if (mStableOutputCurrency !== null) {
                            ...
                            const outputAmountUsdBN = mStableOutputAmountAfterFeeBN
                                .mul(ethers_1.BigNumber.from(allBalances["4"][self.allocations.CURRENCIES.indexOf(mStableOutputCurrency)]))
                                .div((ethers_1.BigNumber.from(10)).pow(internalTokens[mStableOutputCurrency].decimals));
                            return [
                                outputAmountUsdBN,
                                null,
                                getSlippage
                            ...
                            try {
                                var [orders, inputFilledAmountBN, protocolFee, takerAssetFilledAmountBN, makerAssetFilledAmountBN, gasPrice,] = yield (0, _0x_js_1.get0xSwapOrders)(currencyCode === "ETH"
                                    ? "WETH"
                            ...
                            var allBalances = yield self.cache.getOrUpdate("allBalances", self.contracts.RariFundProxy.callStatic.getRawFundBalancesAndPrices);
                            var makerAssetFilledAmountUsdBN = makerAssetFilledAmountBN.mul(ethers_1.BigNumber.from(allBalances["4"][self.allocations.CURRENCIES.indexOf(acceptedCurrency)])).div(ethers_1.BigNumber.from(10).pow(ethers_1.BigNumber.from(internalTokens[acceptedCurrency].decimals)));
                            ...
                            var protocolFeeBN = ethers_1.BigNumber.from(protocolFee).mul(ethers_1.BigNumber.from(15)).div(ethers_1.BigNumber.from(10));
                            // Make sure we have enough ETH for protocol fee
                            var ethBalanceBN = currencyCode === "ETH"
                                ? accountBalanceBN
                                : ethers_1.BigNumber.from(yield provider.getBalance(sender));
                ...
                return __awaiter(this, void 0, void 0, function* () {
                    if (self.POOL_TOKEN_SYMBOL === "RYPT") {
                        ...
                        if (directlyDepositableCurrencyCodes && directlyDepositableCurrencyCodes.length > 0 && directlyDepositableCurrencyCodes.indexOf(currencyCode) >= 0) {
                            var allBalances = yield self.cache.getOrUpdate("allBalances", self.contracts.RariFundProxy.callStatic.getRawFundBalancesAndPrices);
                            return ethers_1.constants.WeiPerEther.sub(usdAmount.mul(ethers_1.BigNumber.from(10)
                                .pow(ethers_1.BigNumber.from(internalTokens[currencyCode].decimals))).div(amount
                                .mul(ethers_1.BigNumber.from(allBalances["4"][self.allocations.CURRENCIES.indexOf(currencyCode)]))
                                .div(ethers_1.constants.WeiPerEther)));
                        }
                    }
                        ...
                        if (currencyCode === "USDC") {
                            return ethers_1.constants.WeiPerEther
                                .sub(usdAmount
                                .mul(ethers_1.BigNumber.from(1e6))
                                .div(amount)).toString();
                        }
                    }
                    ...
                    if (self.cache._raw.coinGeckoUsdPrices
                        ...
                        return ethers_1.constants.WeiPerEther.sub(ethers_1.BigNumber.from(Math.trunc(usdAmount * (Math.pow(10, (currencyCode === "ETH" ? 18 : allTokens[currencyCode].decimals))
                    ...
                    var decoded = yield self.cache.getOrUpdate("coinGeckoList", function () {
                        return __awaiter(this, void 0, void 0, function* () {
                            return (yield axios_1.default.get("https://api.coingecko.com/api/v3/coins/list")).data;
                        });
                    });
                    if (!decoded)
                    ...
                    // Get prices
                    var decoded = (yield axios_1.default.get("https://api.coingecko.com/api/v3/simple/price", {
                        params: {
                            vs_currencies: "usd",
                    ...
                    if (self.cache._raw.coinGeckoUsdPrices.value["USDC"] &&
                        ...
                        if (self.POOL_TOKEN_SYMBOL === "RSPT")
                            ...
                            usdAmount = parseFloat(usdAmount.toString());
                        return ethers_1.constants.WeiPerEther
                            .sub(ethers_1.BigNumber.from(Math.trunc(usdAmount *
                    ...
                    if (directlyDepositableCurrencyCodes.indexOf(currencyCode) >= 0) {
                            ...
                            return __awaiter(this, void 0, void 0, function* () {
                                ...
                                try {
                                    ...
                                    if (allowanceBN.lt(amount)) {
                                        if (allowanceBN.gt(ethers_1.constants.Zero) && currencyCode === "USDT")
                            ...
                            for (var acceptedCurrency of directlyDepositableCurrencyCodes) {
                                if (acceptedCurrency === "mUSD" || mstable_js_1.default.SUPPORTED_EXCHANGE_CURRENCIES.indexOf(acceptedCurrency) >= 0) {
                                    ...
                                    var outputAmountBeforeFeesBN = amount
                                        .mul(internalTokens[acceptedCurrency].decimals === 18
                                        ? ethers_1.constants.WeiPerEther
                                        : ethers_1.BigNumber.from(Math.pow(10, internalTokens[acceptedCurrency].decimals))).div(internalTokens[currencyCode].decimals === 18
                                        ? ethers_1.constants.WeiPerEther
                                        : ethers_1.BigNumber.from(Math.pow(10, internalTokens[currencyCode].decimals)));
                                    if (acceptedCurrency === "mUSD")
                                        mStableOutputAmountAfterFeeBN = outputAmountBeforeFeesBN;
                                        ...
                                        var swapFeeBN = yield self.pools["mStable"].getMUsdSwapFeeBN();
                                        mStableOutputAmountAfterFeeBN = outputAmountBeforeFeesBN.sub(outputAmountBeforeFeesBN.mul(swapFeeBN).div(ethers_1.constants.WeiPerEther));
                                    }
                                }
                                mStableOutputCurrency = acceptedCurrency;
                                break;
                        ...
                        if (mStableOutputCurrency !== null) {
                            ...
                            var outputAmountUsdBN = mStableOutputAmountAfterFeeBN
                                .mul(ethers_1.BigNumber.from(allBalances["4"][self.allocations.CURRENCIES.indexOf(mStableOutputCurrency)]))
                                .div(ethers_1.BigNumber.from(10)
                                .pow(ethers_1.BigNumber.from(internalTokens[mStableOutputCurrency].decimals)));
                            ...
                            try {
                                var allowanceBN = ethers_1.BigNumber.from(yield internalTokens[currencyCode].contract.callStatic.allowance(sender, self.contracts.RariFundProxy.options.address));
                                if (allowanceBN.lt(amount)) {
                                    if (allowanceBN.gt(ethers_1.constants.Zero) && currencyCode === "USDT") {
                            ...
                            var makerAssetFilledAmountUsdBN = makerAssetFilledAmountBN
                                .mul(ethers_1.BigNumber.from(allBalances["4"][self.allocations.CURRENCIES.indexOf(acceptedCurrency)]))
                                .div(ethers_1.BigNumber.from(10)
                                .pow(ethers_1.BigNumber.from(internalTokens[acceptedCurrency].decimals)));
                            // Make sure input amount is completely filled
                            if (inputFilledAmountBN.lt(amount))
                                throw new Error("Unable to find enough liquidity to exchange " +
                                    currencyCode +
                            ...
                            var ethBalanceBN = currencyCode == "ETH"
                                ? accountBalanceBN
                                : ethers_1.BigNumber.from(yield self.provider.getBalance(sender));
                            if (protocolFeeBN.gt(currencyCode === "ETH" ? ethBalanceBN.sub(amount) : ethBalanceBN)) {
                                throw new Error("ETH balance too low to cover 0x exchange protocol fee.");
                            }
                            ...
                            if (currencyCode !== "ETH") {
                                try {
                                    var allowanceBN = ethers_1.BigNumber.from(yield allTokens[currencyCode].contract
                                        .allowance(sender, self.contracts.RariFundProxy.options.address));
                                    if (allowanceBN.lt(amount)) {
                                        if (allowanceBN.gt(ethers_1.constants.Zero) &&
                                            currencyCode === "USDT")
        ...
        this.withdrawals = {
            ...
            getMaxWithdrawalAmount: function (currencyCode, senderUsdBalance, sender) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (currencyCode !== "ETH" && !allTokens[currencyCode])
                        throw new Error("Invalid currency code!");
                    if (!senderUsdBalance || senderUsdBalance.lte(ethers_1.constants.Zero))
                        return [ethers_1.constants.Zero];
                    // Get user fund balance
                    if (senderUsdBalance === undefined)
                        senderUsdBalance = ethers_1.BigNumber.from(yield self.contracts.RariFundManager.callStatic
                            .balanceOf(sender));
                    ...
                    var tokenRawFundBalanceBN = ethers_1.constants.Zero;
                    if (i >= 0) {
                        tokenRawFundBalanceBN = ethers_1.BigNumber.from(allBalances["1"][i]);
                        for (var j = 0; j < allBalances["3"][i].length; j++)
                            tokenRawFundBalanceBN = tokenRawFundBalanceBN.add(ethers_1.BigNumber.from(allBalances["3"][i][j]));
                    }
                    if (tokenRawFundBalanceBN.gt(ethers_1.constants.Zero)) {
                        var maxWithdrawalAmountBN = senderUsdBalance
                            .mul(ethers_1.BigNumber.from(10)
                            .pow(ethers_1.BigNumber.from(internalTokens[currencyCode].decimals)))
                            .div(ethers_1.BigNumber.from(allBalances["4"][self.allocations.CURRENCIES.indexOf(currencyCode)]));
                        if (maxWithdrawalAmountBN
                            .mul(ethers_1.BigNumber.from(allBalances["4"][self.allocations.CURRENCIES.indexOf(currencyCode)]))
                            .div(ethers_1.BigNumber.from(10)
                            .pow(ethers_1.BigNumber.from(internalTokens[currencyCode].decimals)))
                            .gt(senderUsdBalance))
                            maxWithdrawalAmountBN = maxWithdrawalAmountBN.sub(ethers_1.constants.One);
                    ...
                    var amountInputtedUsdBN = ethers_1.constants.Zero;
                    var amountWithdrawnBN = ethers_1.constants.Zero;
                    var totalProtocolFeeBN = ethers_1.constants.Zero;
                    ...
                    for (var i = 0; i < allBalances["0"].length; i++) {
                        ...
                        if (inputCurrencyCode !== currencyCode) {
                            var rawFundBalanceBN = ethers_1.BigNumber.from(allBalances["1"][i]);
                            for (var j = 0; j < allBalances["3"][i].length; j++)
                                rawFundBalanceBN = rawFundBalanceBN.add(ethers_1.BigNumber.from(allBalances["3"][i][j]));
                            if (rawFundBalanceBN.gt(ethers_1.constants.Zero)) {
                    ...
                    function updateMaxInputs() {
                        ...
                        for (const inputCandidate of inputCandidates) {
                            ...
                            var maxInputAmountLeftBN = usdAmountLeft
                                .mul(ethers_1.BigNumber.from(10)
                                .pow(ethers_1.BigNumber.from(internalTokens[inputCandidate.currencyCode].decimals)))
                                .div(ethers_1.BigNumber.from(allBalances["4"][self.allocations.CURRENCIES.indexOf(inputCandidate.currencyCode)]));
                            if (maxInputAmountLeftBN
                                .mul(ethers_1.BigNumber.from(allBalances["4"][self.allocations.CURRENCIES.indexOf(inputCandidate.currencyCode)]))
                                .div(ethers_1.BigNumber.from(10)
                                .pow(ethers_1.BigNumber.from(internalTokens[inputCandidate.currencyCode]
                                .decimals)))
                                .gt(usdAmountLeft))
                                maxInputAmountLeftBN = maxInputAmountLeftBN.sub(ethers_1.constants.One);
                            ...
                            if (inputAmountBN.gt(ethers_1.constants.Zero))
                    ...
                    // mStable
                    if (currencyCode === "mUSD" ||
                        mstable_js_1.default.SUPPORTED_EXCHANGE_CURRENCIES.indexOf(currencyCode) >=
                            0) {
                        var mStableSwapFeeBN = null;
                        for (var i = 0; i < inputCandidates.length; i++) {
                            if (inputCandidates[i].currencyCode !== "mUSD" &&
                                mstable_js_1.default.SUPPORTED_EXCHANGE_CURRENCIES.indexOf(inputCandidates[i].currencyCode) < 0)
                                continue;
                            var mStableInputAmountBN = inputCandidates[i].inputAmountBN;
                            var mStableOutputAmountAfterFeesBN = ethers_1.constants.Zero;
                            ...
                            if (inputCandidates[i].currencyCode === "mUSD") {
                                ...
                                if (!redeemValidity || !redeemValidity["0"])
                                    continue;
                                mStableOutputAmountAfterFeesBN = ethers_1.BigNumber.from(redeemValidity["2"]);
                            }
                            else {
                                try {
                                ...
                                if (!maxSwap ||
                                    !maxSwap["0"] ||
                                    ethers_1.BigNumber.from(maxSwap["2"]).lte(ethers_1.constants.Zero))
                                    continue;
                                mStableInputAmountBN =
                                    mStableInputAmountBN.lt(ethers_1.BigNumber.from(maxSwap["2"])) ? mStableInputAmountBN : ethers_1.BigNumber.from(maxSwap["2"]);
                                var outputAmountBeforeFeesBN = mStableInputAmountBN
                                    .mul(ethers_1.BigNumber.from(10).pow(ethers_1.BigNumber.from(internalTokens[currencyCode].decimals)))
                                    .div(ethers_1.BigNumber.from(10).pow(ethers_1.BigNumber.from(internalTokens[inputCandidates[i].currencyCode].decimals)));
                                if (currencyCode === "mUSD")
                            ...
                            amountInputtedUsdBN = amountInputtedUsdBN.add(mStableInputAmountBN
                                .mul(ethers_1.BigNumber.from(allBalances["4"][self.allocations.CURRENCIES.indexOf(inputCandidates[i].currencyCode)]))
                                .div(ethers_1.BigNumber.from(10)
                                .pow(ethers_1.BigNumber.from(internalTokens[inputCandidates[i].currencyCode]
                                .decimals))));
                            ...
                            if (amountInputtedUsdBN.gte(senderUsdBalance.sub(ethers_1.BigNumber.from(10).mul(ethers_1.BigNumber.from(16)))))
                                break;
                        }
                    }
                    // Use 0x if necessary
                    // Deal with amountInputtedUsdBN.lt(senderUsdBalance) not being accurate better than 1 cent margin of error
                    if (amountInputtedUsdBN.lt(senderUsdBalance.sub(ethers_1.BigNumber.from(10).mul(ethers_1.BigNumber.from(16)))) &&
                        inputCandidates.length > 0) {
                        // Get orders from 0x swap API for each input currency candidate
                        for (var i = 0; i < inputCandidates.length; i++) {
                            try {
                                var [orders, inputFilledAmountBN, protocolFee, takerAssetFilledAmountBN, makerAssetFilledAmountBN, gasPrice,] = yield (0, _0x_js_1.get0xSwapOrders)(internalTokens[inputCandidates[i].currencyCode].address, currencyCode === "ETH"
                                    ? "WETH"
                            ...
                            inputCandidates[i].protocolFeeBN = ethers_1.BigNumber.from(protocolFee).mul(ethers_1.BigNumber.from(15)).div(ethers_1.BigNumber.from(10)); // Multiply protocol fee by 1.5 to account for user upping the gas price
                        ...
                        for (var i = 0; i < inputCandidates.length; i++) {
                            ...
                            var inputFillAmountUsdBN = inputCandidates[i].inputFillAmountBN
                                ...
                                .pow(ethers_1.BigNumber.from(internalTokens[inputCandidates[i].currencyCode]
                                .decimals)));
                            if (inputFillAmountUsdBN.gte(usdAmountLeft.sub(ethers_1.BigNumber.from(10).mul(ethers_1.BigNumber.from(16))))) {
            ...
            validateWithdrawal: function (currencyCode, amount, sender, getSlippage) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (tokenRawFundBalanceBN.gte(amount)) {
                        var amountUsdBN = amount
                            .mul(ethers_1.BigNumber.from(allBalances["4"][self.allocations.CURRENCIES.indexOf(currencyCode)]))
                            .div(ethers_1.BigNumber.from(10).pow(ethers_1.BigNumber.from(internalTokens[currencyCode].decimals)));
                        // Check amountUsdBN against user fund balance
                        var senderUsdBalance = ethers_1.BigNumber.from(yield self.contracts.RariFundManager.callStatic
                            .balanceOf(sender));
                        ...
                        // Return amountUsdBN
                        return [amountUsdBN, null, ethers_1.constants.Zero];
                    }
                    else {
                        // Otherwise, exchange as few currencies as possible (ideally those with the lowest balances)
                        var amountInputtedUsdBN = ethers_1.constants.Zero;
                        ...
                        for (var i = 0; i < allBalances["0"].length; i++) {
                            if (allBalances["0"][i] !== currencyCode) {
                                var rawFundBalanceBN = ethers_1.constants.Zero;
                                for (var j = 0; j < allBalances["3"][i].length; j++)
                                    rawFundBalanceBN = rawFundBalanceBN.add(ethers_1.BigNumber.from(allBalances["3"][i][j]));
                                if (rawFundBalanceBN.gt(ethers_1.constants.Zero))
                                    inputCandidates.push({
                        ...
                        // mStable
                        if (currencyCode === "mUSD" ||
                            mstable_js_1.default.SUPPORTED_EXCHANGE_CURRENCIES.indexOf(currencyCode) >= 0) {
                            ...
                            for (var i = 0; i < inputCandidates.length; i++) {
                                ...
                                if (currencyCode !== "mUSD" && mStableSwapFeeBN === null) {
                                    ...
                                    var inputAmountBN = amount
                                        ...
                                        .mul(ethers_1.constants.WeiPerEther)
                                        .div(ethers_1.constants.WeiPerEther.sub(mStableSwapFeeBN))
                                        .mul(internalTokens[inputCandidates[i].currencyCode].decimals === 18
                                        ? ethers_1.constants.WeiPerEther
                                        : ethers_1.BigNumber.from(Math.pow(10, internalTokens[inputCandidates[i].currencyCode].decimals))).div(allTokens[currencyCode].decimals === 18
                                        ? ethers_1.constants.WeiPerEther
                                        : ethers_1.BigNumber.from(Math.pow(10, allTokens[currencyCode].decimals)));
                                    var outputAmountBeforeFeesBN = inputAmountBN
                                        ...
                                        ? ethers_1.constants.WeiPerEther
                                        : ethers_1.BigNumber.from(Math.pow(10, internalTokens[inputCandidates[i].currencyCode].decimals)));
                                    ...
                                    while (outputAmountBN.lt(amount.sub(amountWithdrawnBN))) {
                                        ...
                                        inputAmountBN = inputAmountBN.add(ethers_1.constants.One); // Make sure we have enough input amount to receive amount.sub(amountWithdrawnBN)
                                        outputAmountBeforeFeesBN = inputAmountBN
                                            .mul(ethers_1.BigNumber.from(10).pow(ethers_1.BigNumber.from(allTokens[currencyCode].decimals)))
                                            .div(ethers_1.BigNumber.from(10).pow(internalTokens[inputCandidates[i].currencyCode].decimals));
                                        outputAmountBN =
                                            currencyCode === "mUSD"
                                                ? outputAmountBeforeFeesBN
                                                : outputAmountBeforeFeesBN.sub(outputAmountBeforeFeesBN
                                    ...
                                    if (inputAmountBN.gt(inputCandidates[i].rawFundBalanceBN)) {
                                        ...
                                        outputAmountBeforeFeesBN = inputAmountBN
                                            .mul(ethers_1.BigNumber.from(10).pow(allTokens[currencyCode].decimals))
                                            .div(ethers_1.BigNumber.from(10).pow(internalTokens[inputCandidates[i].currencyCode].decimals));
                                        outputAmountBN =
                                            currencyCode === "mUSD"
                                                ? outputAmountBeforeFeesBN
                                    ...
                                    if (inputCandidates[i].currencyCode === "mUSD") {
                                        ...
                                        if (!outputAmountBN.eq(ethers_1.BigNumber.from(redeemValidity["2"])))
                                        ...
                                        if (!maxSwap ||
                                            !maxSwap["0"] ||
                                            ethers_1.BigNumber.from(maxSwap["2"]).lt(inputAmountBN))
                                            continue;
                                    }
                                    amountInputtedUsdBN = amountInputtedUsdBN.add(inputAmountBN
                                        .mul(ethers_1.BigNumber.from(allBalances["4"][self.allocations.CURRENCIES.indexOf(inputCandidates[i].currencyCode)])).div(ethers_1.BigNumber.from(10)
                                        .pow(ethers_1.BigNumber.from(internalTokens[inputCandidates[i].currencyCode]
                                        .decimals))));
                        ...
                        if (amountWithdrawnBN.lt(amount)) {
                            ...
                            for (var i = 0; i < inputCandidates.length; i++) {
                                ...
                                inputCandidates[i].inputFillAmountBN = inputFilledAmountBN;
                                inputCandidates[i].protocolFeeBN = ethers_1.BigNumber.from(protocolFee)
                                    .mul(ethers_1.BigNumber.from(15))
                                    .div(ethers_1.BigNumber.from(10)); // Multiply protocol fee by 1.5 to account for user upping the gas price
                                inputCandidates[i].takerAssetFillAmountBN = takerAssetFilledAmountBN;
                                inputCandidates[i].makerAssetFillAmountBN = makerAssetFilledAmountBN;
                                inputCandidates[i].takerAssetFillAmountUsdBN = takerAssetFilledAmountBN
                                    .mul(ethers_1.BigNumber.from(allBalances["4"][self.allocations.CURRENCIES.indexOf(inputCandidates[i].currencyCode)]))
                            ...
                            for (var i = 0; i < inputCandidates.length; i++) {
                                if (inputCandidates[i].makerAssetFillAmountBN.gte(amount.sub(amountWithdrawnBN))) {
                                    ...
                                    while (inputCandidates[i].makerAssetFillAmountBN
                                        ...
                                        if (tries >= 1000)
                                            throw new Error("Failed to get increment order input amount to achieve desired output amount.");
                                        thisInputAmountBN.iadd(ethers_1.constants.One); // Make sure we have enough input fill amount to achieve this maker asset fill amount
                                        tries++;
                                    }
                                    amountInputtedUsdBN = amountInputtedUsdBN.add(thisInputAmountBN
                                        .mul(ethers_1.BigNumber.from(allBalances["4"][self.allocations.CURRENCIES.indexOf(inputCandidates[i].currencyCode)]))
                        ...
                        var senderUsdBalance = ethers_1.BigNumber.from(yield self.contracts.RariFundManager.calStatic.balanceOf(sender));
                        if (amountInputtedUsdBN.gt(senderUsdBalance))
                            throw new Error("Requested withdrawal amount is greater than the sender's " +
                                self.POOL_NAME +
                                " balance. Please click the max button and try again (or reload and try again later if the issue persists).");
                ...
                return __awaiter(this, void 0, void 0, function* () {
                    if (self.POOL_TOKEN_SYMBOL === "RYPT") {
                        ...
                        if (directlyDepositableCurrencyCodes &&
                            ...
                            var allBalances = yield self.cache.getOrUpdate("allBalances", self.contracts.RariFundProxy.callStatic.getRawFundBalancesAndPrices);
                            return ethers_1.constants.WeiPerEther.sub(amount
                                .mul(ethers_1.BigNumber.from(allBalances["4"][self.allocations.CURRENCIES.indexOf(currencyCode)]))
                                .div(ethers_1.constants.WeiPerEther)
                                .mul(ethers_1.BigNumber.from(10)
                                .pow(ethers_1.BigNumber.from(36 - internalTokens[currencyCode].decimals)))
                                .div(usdAmount));
                        }
                    }
                    else if (self.POOL_TOKEN_SYMBOL === "RSPT") {
                        if (currencyCode === "USDC")
                            return ethers_1.constants.WeiPerEther
                                .sub(amount
                                .mul(ethers_1.BigNumber.from(10).pow(ethers_1.BigNumber.from(36 - 6)))
                                .div(usdAmount))
                                .toString();
                        if (currencyCode === "mUSD")
                            return ethers_1.constants.WeiPerEther
                                .sub(amount.mul(ethers_1.constants.WeiPerEther).div(usdAmount))
                                .toString();
                    }
                    else if (self.POOL_TOKEN_SYMBOL === "RDPT") {
                        if (currencyCode === "DAI")
                    ...
                    if (self.cache._raw.coinGeckoUsdPrices &&
                        ...
                        if (self.POOL_TOKEN_SYMBOL === "RSPT")
                            ...
                            usdAmount = parseFloat(usdAmount.toString());
                        return ethers_1.constants.WeiPerEther
                            .sub(ethers_1.BigNumber.from(Math.trunc((parseFloat(amount.toString()) *
                            self.cache._raw.coinGeckoUsdPrices.value[currencyCode] *
                            Math.pow(10, (currencyCode === "ETH"
                                ? 18
            ...
            withdraw: function (currencyCode, amount, maxUsdAmount, options) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (tokenRawFundBalanceBN.gte(amount)) {
                        ...
                        let protocolFeeBNs = [];
                        let amountInputtedUsdBN = ethers_1.constants.Zero;
                        let amountWithdrawnBN = ethers_1.constants.Zero;
                        let totalProtocolFeeBN = ethers_1.constants.Zero;
                        // Withdraw as much as we can of the output token first
                        if (tokenRawFundBalanceBN.gt(ethers_1.constants.Zero)) {
                            ...
                            allOrders.push([]);
                            allSignatures.push([]);
                            makerAssetFillAmountBNs.push(ethers_1.constants.Zero);
                            protocolFeeBNs.push(ethers_1.constants.Zero);
                            amountInputtedUsdBN = amountInputtedUsdBN.add(tokenRawFundBalanceBN
                                .mul(ethers_1.BigNumber.from(allBalances["4"][self.allocations.CURRENCIES.indexOf(currencyCode)]))
                                .div(ethers_1.BigNumber.from(10)
                                .pow(ethers_1.BigNumber.from(internalTokens[currencyCode].decimals))));
                        ...
                        if (currencyCode === "mUSD" ||
                            ...
                            for (var i = 0; i < inputCandidates.length; i++) {
                                ...
                                var inputAmountBN = amount
                                    ...
                                    .mul(ethers_1.constants.WeiPerEther)
                                    .div(ethers_1.constants.WeiPerEther.sub(mStableSwapFeeBN))
                                    .mul(ethers_1.BigNumber.from(10).pow(ethers_1.BigNumber.from(internalTokens[inputCandidates[i].currencyCode]
                                    .decimals)))
                                    .div(ethers_1.BigNumber.from(10).pow(ethers_1.BigNumber.from(allTokens[currencyCode].decimals)));
                                var outputAmountBeforeFeesBN = inputAmountBN
                                    .mul(ethers_1.BigNumber.from(10).pow(ethers_1.BigNumber.from(allTokens[currencyCode].decimals)))
                                    .div(ethers_1.BigNumber.from(10).pow(ethers_1.BigNumber.from(internalTokens[inputCandidates[i].currencyCode]
                                    .decimals)));
                            ...
                            for (var i = 0; i < inputCandidates.length; i++) {
                                ...
                                if (inputCandidates[i].makerAssetFillAmountBN.gte(amount.sub(amountWithdrawnBN))) {
                                    ...
                                    while (inputCandidates[i].makerAssetFillAmountBN
                                        ...
                                        if (tries >= 1000)
                                            throw new Error("Failed to get increment order input amount to achieve desired output amount.");
                                        thisInputAmountBN = thisInputAmountBN.add(ethers_1.constants.One); // Make sure we have enough input fill amount to achieve this maker asset fill amount
                                        tries++;
                                    }
                                    inputCurrencyCodes.push(inputCandidates[i].currencyCode);
        ...
        const internalTokens = {
            DAI: {
                ...
                name: "Dai Stablecoin",
                decimals: 18,
                Contract: new ethers_1.Contract("0x6b175474e89094c44da98b954eedeac495271d0f", ERC20_json_1.default, this.provider.getSigner())
            },
            USDC: {
                symbol: "USDC",
                ...
                name: "USD Coin",
                decimals: 6,
                Contract: new ethers_1.Contract("0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48", ERC20_json_1.default, this.provider.getSigner())
            },
            USDT: {
                symbol: "USDT",
                ...
                name: "Tether USD",
                decimals: 6,
                Contract: new ethers_1.Contract("0xdac17f958d2ee523a2206206994597c13d831ec7", ERC20_json_1.default, this.provider.getSigner())
            },
            TUSD: {
                symbol: "TUSD",
                ...
                name: "TrueUSD",
                decimals: 18,
                Contract: new ethers_1.Contract("0x0000000000085d4780b73119b644ae5ecd22b376", ERC20_json_1.default, this.provider.getSigner())
            },
            BUSD: {
                symbol: "BUSD",
                ...
                name: "Binance USD",
                decimals: 18,
                Contract: new ethers_1.Contract("0x4Fabb145d64652a948d72533023f6E7A623C7C53", ERC20_json_1.default, this.provider.getSigner())
            },
            sUSD: {
                symbol: "sUSD",
                ...
                name: "sUSD",
                decimals: 18,
                Contract: new ethers_1.Contract("0x57ab1ec28d129707052df4df418d58a2d46d5f51", ERC20_json_1.default, this.provider.getSigner())
            },
            mUSD: {
                symbol: "mUSD",
                ...
                name: "mStable USD",
                decimals: 18,
                Contract: new ethers_1.Contract("0xe2f2a5c287993345a840db3b0845fbc70f5935a5", ERC20_json_1.default, this.provider.getSigner())
            },
        };
    }
}
