...
class Fuse {
    constructor(web3Provider) {
        ...
        this.contracts = {
            FusePoolDirectory: new ethers_1.Contract(Fuse.FUSE_POOL_DIRECTORY_CONTRACT_ADDRESS, FusePoolDirectory_json_1.default, this.provider),
            FusePoolLens: new ethers_1.Contract(Fuse.FUSE_POOL_LENS_CONTRACT_ADDRESS, FusePoolLens_json_1.default, this.provider),
            FusePoolLensSecondary: new ethers_1.Contract(Fuse.FUSE_POOL_LENS_SECONDARY_CONTRACT_ADDRESS, FusePoolLensSecondary_json_1.default, this.provider),
            FuseSafeLiquidator: new ethers_1.Contract(Fuse.FUSE_SAFE_LIQUIDATOR_CONTRACT_ADDRESS, FuseSafeLiquidator_json_1.default, this.provider),
            FuseFeeDistributor: new ethers_1.Contract(Fuse.FUSE_FEE_DISTRIBUTOR_CONTRACT_ADDRESS, FuseFeeDistributor_json_1.default, this.provider)
        };
        ...
        whitelist // An array of whitelisted addresses
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let poolAddress = ethers_1.utils.getCreate2Address(Fuse.FUSE_POOL_DIRECTORY_CONTRACT_ADDRESS, saltsHash, byteCodeHash);
                ...
                // Whitelist
                if (enforceWhitelist) {
                    let comptroller = new ethers_1.Contract(poolAddress, JSON.parse(this.compoundContracts["contracts/Comptroller.sol:Comptroller"].abi), this.provider);
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                switch (model) {
                    ...
                    case "UniswapTwapPriceOracleV2": // Uniswap V2 TWAPs
                        ...
                        oracleFactoryContract = new ethers_1.Contract(Fuse.UNISWAP_TWAP_PRICE_ORACLE_V2_FACTORY_CONTRACT_ADDRESS, this.oracleContracts.UniswapTwapPriceOracleV2Factory.abi, this.provider.getSigner());
                    ...
                    case "UniswapV3TwapPriceOracleV2":
                        ...
                        // Check for existing oracle
                        oracleFactoryContract = new ethers_1.Contract(Fuse.UNISWAP_V3_TWAP_PRICE_ORACLE_V2_FACTORY_CONTRACT_ADDRESS, this.oracleContracts.UniswapV3TwapPriceOracleV2Factory.abi, this.provider.getSigner());
                    ...
                    case "MasterPriceOracle":
                        var initializableClones = new ethers_1.Contract(Fuse.INITIALIZABLE_CLONES_CONTRACT_ADDRESS, InitializableClones_json_1.default, this.provider.getSigner());
                        var masterPriceOracle = new abi_1.Interface(oracles_min_json_1.default["MasterPriceOracle"].abi);
                        deployArgs = [
        ...
        this.deployCToken = function (conf, collateralFactor, reserveFactor, adminFee, options, bypassPriceFeedCheck) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if ((!collateralFactorBN.gte(ethers_1.constants.Zero)) ||
                    collateralFactorBN.gt(ethers_1.utils.parseUnits("0.9", 18)))
                ...
                if (reserveFactorBN.gt(ethers_1.constants.Zero) ||
                    adminFeeBN.gt(ethers_1.constants.Zero)) {
        ...
        this.deployCEther = function (conf, supportMarket, collateralFactor, reserveFactor, adminFee, options, implementationAddress) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                var comptroller = new ethers_1.Contract(conf.comptroller, JSON.parse(this.compoundContracts["contracts/Comptroller.sol:Comptroller"].abi), this.provider.getSigner());
                ...
                const byteCodeHash = ethers_1.utils.keccak256("0x" + this.compoundContracts["contracts/CEtherDelegator.sol:CEtherDelegator"].bin);
                const cEtherDelegatorAddress = ethers_1.utils.getCreate2Address(Fuse.FUSE_FEE_DISTRIBUTOR_CONTRACT_ADDRESS, saltsHash, byteCodeHash);
        ...
        this.deployCErc20 = function (conf, collateralFactor, reserveFactor, adminFee, options, bypassPriceFeedCheck, implementationAddress // cERC20Delegate implementation
            ...
            return __awaiter(this, void 0, void 0, function* () {
                // Get Comptroller
                var comptroller = new ethers_1.Contract(conf.comptroller, JSON.parse(this.compoundContracts["contracts/Comptroller.sol:Comptroller"].abi));
                ...
                const byteCodeHash = ethers_1.utils.keccak256("0x" + this.compoundContracts["contracts/Unitroller.sol:Unitroller"]);
                const cErc20DelegatorAddress = ethers_1.utils.getCreate2Address(Fuse.FUSE_FEE_DISTRIBUTOR_CONTRACT_ADDRESS, saltsHash, byteCodeHash);
                // Return cToken proxy and implementation contract addresses
                ...
                if (chainlinkPriceFeed === undefined || !chainlinkPriceFeed) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            // If not, add it!
                            const underlyingToken = new ethers_1.Contract(conf.underlying, JSON.parse(this.compoundContracts["contracts/EIP20Interface.sol:EIP20Interface"].abi), this.provider);
                                ...
                                yield uniswapOrUniswapAnchoredViewContract
                                    .add([
                                    {
                                        ...
                                        baseUnit: ethers_1.BigNumber.from(10)
                                            .pow(ethers_1.BigNumber.from(underlyingDecimals))
                                            .toString(),
                            ...
                            function promptForUniswapV2Pair(self) {
                                return __awaiter(this, void 0, void 0, function* () {
                                    ...
                                    const salt = ethers_1.utils.solidityKeccak256(["string", "string"], [conf.underlying, Fuse.WETH_ADDRESS]);
                                    let uniswapV2Pair = ethers_1.utils.getCreate2Address(Fuse.UNISWAP_V2_FACTORY_ADDRESS, salt, Fuse.UNISWAP_V2_PAIR_INIT_CODE_HASH);
                                    ...
                                    if (isUniswapAnchoredView) {
                                        ...
                                        if (ethers_1.BigNumber.from(yield priceData.getPrice(reporter, underlyingSymbol))
                                            .gt(ethers_1.constants.Zero))
                                            yield uniswapOrUniswapAnchoredViewContract
        ...
        this.checkCardinality = function (uniswapV3Pool) {
            return __awaiter(this, void 0, void 0, function* () {
                var uniswapV3PoolContract = new ethers_1.Contract(uniswapV3Pool, UniswapV3Pool_slim_json_1.default);
