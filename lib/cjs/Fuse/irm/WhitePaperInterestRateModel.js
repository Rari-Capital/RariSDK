...
class WhitePaperInterestRateModel {
    init(interestRateModelAddress, assetAddress, provider) {
        return __awaiter(this, void 0, void 0, function* () {
            const whitePaperModelContract = (0, web3_1.createContract)(interestRateModelAddress, compound_protocol_min_json_1.default.contracts["contracts/WhitePaperInterestRateModel.sol:WhitePaperInterestRateModel"].abi, provider);
            ...
            const cTokenContract = (0, web3_1.createContract)(assetAddress, JSON.parse(compound_protocol_min_json_1.default.contracts["contracts/CTokenInterfaces.sol:CTokenInterface"].abi), provider);
