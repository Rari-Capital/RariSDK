...
class JumpRateModel {
    init(interestRateModelAddress, assetAddress, provider) {
        return __awaiter(this, void 0, void 0, function* () {
            const jumpRateModelContract = (0, web3_1.createContract)(interestRateModelAddress, compound_protocol_min_json_1.default.contracts["contracts/JumpRateModel.sol:JumpRateModel"].abi, provider);
